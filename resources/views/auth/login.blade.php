...
<head>
    ...
    <style>
        ...
        /* Inputs - Solo dejamos la versión Light como en la imagen 2 */
        .input-light {
...
<body class="bg-black antialiased">
    <div class="relative min-h-screen bg-login flex items-center">
        ...
        <div class="absolute top-0 left-0 p-8 z-20">
            <a href="{{ url('/') }}" class="flex items-center gap-2 text-white/70 hover:text-white transition-all no-underline">
                        ...
                        <div class="glass-panel rounded-2xl px-8 py-9 md:px-10 md:py-10">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                                ...
                                <div>
                                    ...
                                    {{-- CAMBIO: Se aplicó input-light aquí --}}
                                    <input
                                        type="email"
                                        name="email"
                                        value="{{ old('email') }}"
                                ...
                                <button type="submit" class="btn-blue w-full py-3.5 rounded-lg text-white font-semibold tracking-wide shadow-lg">
                                    Iniciar Sesión
                                </button>

                                <div class="text-center pt-1">
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" class="text-xs text-blue-300 hover:text-blue-200 underline decoration-blue-400/30">
