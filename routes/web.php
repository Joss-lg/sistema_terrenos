...
Route::put('inventario/{terreno}', [InventarioController::class, 'update'])
    ...
    ->middleware('permiso:inventario,editar');
    Route::post('/inventario/{id}/asignar-cliente', [InventarioController::class, 'asignarCliente'])
    ->name('inventario.asignarCliente');
...
Route::get('ventas/contrato/{venta}', [VentaController::class, 'contratoPDF'])
    ...
    Route::get('/ventas/contrato/{id}', [VentaController::class, 'descargarContrato'])->name('ventas.contrato');
